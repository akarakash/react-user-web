...
const FormL = ({ isSignup }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    const url = isSignup ? 'https://your-api-endpoint.com/signup' : 'https://your-api-endpoint.com/login';
    ...
    try {
      ...
      setMessage(isSignup ? 'Signup failed. Try again.' : 'Login failed. Try again.');
...
<Container maxWidth="xs" className='form-page'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Grid container>
          <Grid item>
            <Link  top={'/signup'} href={isSignup ? '/login' : '/signup'} variant="body2">
